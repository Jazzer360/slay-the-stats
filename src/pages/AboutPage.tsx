    ...
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-400 leading-relaxed mb-3">
          ...
          head-to-head match: the card you picked "wins" against each card you passed on.
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-2 text-sm mb-3">
          ...
          <li>
            Win rates, average floor, and deck stats all reflect only the filtered subset.
          </li>
          <li>
            Switching filters instantly re-derives everything — no cached numbers.
          </li>
        </ul>
        <p className="text-gray-500 text-sm">
          Because ELO requires many matchups to stabilize, filtering to a small subset of runs
          will produce noisier ratings. The full run set gives the most reliable ELO picture.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3 text-sm text-gray-400">
          ...
          <p className="text-gray-500">
            ...
            <a href="/import" className="text-purple-400 hover:text-purple-300">Import</a> page.
          </p>
        </div>
      </section>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3 text-sm text-gray-400">
          ...
          <p>
            Any individual run can be shared via its detail page — click <span className="text-gray-300">Share Run</span>{' '}
            to get a link. The link works for anyone with it, no account required.
          </p>
          <p className="text-gray-500">
      ...
      <section>
        ...
        <p className="text-gray-400 text-sm leading-relaxed">
          ...
          achieve the same result using the{' '}
          <a href="/import" className="text-purple-400 hover:text-purple-300">Import</a> page's
          "Replace all runs" option: wipe your current history and re-upload only the profile folder
          you want to analyze.
        </p>
      </section>
    </div>
